...
(function(t, n) {
    ...
    function qt(t) {
        ...
        var e = It(t.r),
            r = It(t.g),
            i = It(t.b),
            o = Dt((.4124564 * e + .3575761 * r + .1804375 * i) / Yl),
    ...
    function Ce(n) {
        ...
        function u() {
            ...
            function o() {
                ...
                _ < h && (S *= -1, t = l, l = v, v = t, t = h, h = _, _ = t, N in yd && Y.attr("cursor", _d[N = yd[N]])), g < d && (E *= -1, t = p, p = y, y = t, t = d, d = g, g = t, N in gd && Y.attr("cursor", _d[N = gd[N]])), A.selection && (z = A.selection), w && (h = z[0][0], _ = z[1][0]), M && (d = z[0][1], g = z[1][1]), z[0][0] === h && z[0][1] === d && z[1][0] === _ && z[1][1] === g || (A.selection = [
                    [h, d],
                    [_, g]
                ], r.call(T), F.brush())
            }
        ...
        return e.move = function(t, e) {
            ...
            return arguments.length ? (s = "function" == typeof t ? t : ud([
                [+t[0][0], +t[0][1]],
                [+t[1][0], +t[1][1]]
            ]), e) : s
        }, e.filter = function(t) {
    ...
    function Ii(t, n, e, r) {
        var i;
        if (null == t) i = e * w_, r.point(-b_, i), r.point(0, i), r.point(b_, i), r.point(b_, 0), r.point(b_, -i), r.point(0, -i), r.point(-b_, -i), r.point(-b_, 0), r.point(-b_, i);
    ...
    function $i(t) {
        ...
        return n.stream = function(t) {
                ...
                return arguments.length ? (S = null == t ? (k = l = h = p = null, ky) : ci(k = +t[0][0], l = +t[0][1], h = +t[1][0], p = +t[1][1]), o()) : null == k ? null : [
                    [k, l],
                    [h, p]
                ]
            }, n.scale = function(t) {
    ...
    function wo(t, n) {
        var e, r, i, o, u, a = new So(t),
            c = +t.value && (a.value = t.value),
            s = [a];
        for (null == n && (n = To); e = s.pop();)
            if (c && (e.value = +e.data.value), (i = n(e.data)) && (u = i.length))
                for (e.children = new Array(u), o = u - 1; o >= 0; --o) s.push(r = e.children[o] = new So(i[o])), r.parent = e, r.depth = e.depth + 1;
    ...
    function Fo(t) {
        ...
        t: for (a = 3; a < i; ++a) {
            ...
            while (c !== s.next);
            for (r.previous = n, r.next = e, n.next = e.previous = e = r, v += d = r._.r * r._.r, _ += d * r._.x, y += d * r._.y, h = Do(n, o = _ / v, u = y / v);
                (r = r.next) !== e;)(d = Do(r, o, u)) < h && (n = r, h = d);
            e = n.next
        }
        for (n = [e._], r = e;
    ...
    function eu(t) {
        for (var n, e, r, i, o, u = new nu(t, 0), a = [u]; n = a.pop();)
            if (r = n._.children)
                for (n.children = new Array(o = r.length), i = o - 1; i >= 0; --i) a.push(e = n.children[i] = new nu(r[i], i)), e.parent = n;
    ...
    function gs(t, n) {
        ...
        for (Ew = [], kw = new Array(t.length), Nw = new jc, Sw = new jc;;)
            if (i = Tw, o && (!i || o[1] < i.y || o[1] === i.y && o[0] < i.x)) o[0] === e && o[1] === r || (ps(o), e = o[0], r = o[1]), o = t.pop();
            else {
                if (!i) break;
                hs(i.arc)
            }
    ...
    var ks = "4.6.0",
        ...
        qs = function(t, n) {
            var e, r, i = t.length,
                ...
                c = 0;
            if (null == n)
                for (; ++a < i;) isNaN(e = Rs(t[a])) || (r = e - o, o += r / ++c, u += r * (e - o));
            else
                for (; ++a < i;) isNaN(e = Rs(n(t[a], a, t))) || (r = e - o, o += r / ++c, u += r * (e - o));
            if (c > 1) return u / (c - 1)
        },
        Ls = function(t, n) {
            var e = qs(t, n);
        ...
        Ks = function(t, n) {
            var e, r = 0,
                ...
                u = i;
            if (null == n)
                for (; ++o < i;) isNaN(e = Rs(t[o])) ? --u : r += e;
            else
                for (; ++o < i;) isNaN(e = Rs(n(t[o], o, t))) ? --u : r += e;
            if (u) return r / u
        },
        tf = function(t, n) {
            var e, r = [],
                ...
                o = -1;
            if (null == n)
                for (; ++o < i;) isNaN(e = Rs(t[o])) || r.push(e);
            else
                for (; ++o < i;) isNaN(e = Rs(n(t[o], o, t))) || r.push(e);
    ...
    var eh, rh, ih, oh, uh, ah, ch = function(t) {
        ...
        xh = function(t, n) {
            var e, r, i, o = gh.lastIndex = mh.lastIndex = 0,
                u = -1,
                a = [],
                c = [];
            for (t += "", n += "";
                (e = gh.exec(t)) && (r = mh.exec(n));)(i = r.index) > o && (i = n.slice(o, i), a[u] ? a[u] += i : a[++u] = i), (e = e[0]) === (r = r[0]) ? a[u] ? a[u] += r : a[++u] = r : (a[++u] = null, c.push({
                i: u,
                x: _h(e, r)
            })), o = mh.lastIndex;
    ...
    var Zh = function(t, n, e) {
        ...
        xp = function(t) {
            ...
            for (var r = this._groups, i = r.length, o = new Array(i), u = 0; u < i; ++u)
                for (var a, c, s = r[u], f = s.length, l = o[u] = new Array(f), h = 0; h < f; ++h)(a = s[h]) && (c = t.call(a, a.__data__, h, s)) && ("__data__" in a && (c.__data__ = a.__data__), l[h] = c, up(l[h], n, e, h, l, Tn(a, e)));
    ...
    var Cp = 3,
        ...
        rd = function(t) {
            ...
            for (var r = this._groups, i = r.length, o = 0; o < i; ++o)
                for (var u, a = r[o], c = a.length, s = 0; s < c; ++s)(u = a[s]) && up(u, t, n, s, a, e || xe(u, n));
    ...
    var id = [null],
        od = function(t, n) {
            ...
            if (i) {
                n = null == n ? null : n + "";
                for (r in i)
                    if ((e = i[r]).state > tp && e.name === n) return new Qn([
                        [t]
                    ], id, n, +r)
            }
            return null
    ...
    Fe.prototype = Ie.prototype = {
        ...
        entries: function() {
            var t = [];
            for (var n in this) n[0] === Ud && t.push({
                key: n.slice(1),
                value: this[n]
            });
            return t
    ...
    var Fd = function(t) {
        ...
        av = function(t, n, e) {
            var r, i, o, u, a, c, s, f = this._x0,
                ...
                d = [],
                v = this._root;
            for (v && d.push(new uv(v, f, l, h, p)), null == e ? e = 1 / 0 : (f = t - e, l = n - e, h = t + e, p = n + e, e *= e); c = d.pop();)
        ...
        lv = function(t) {
            var n, e, r, i, o, u, a = [],
                c = this._root;
            for (c && a.push(new uv(c, this._x0, this._y0, this._x1, this._y1)); n = a.pop();)
        ...
        gv = function(t) {
            ...
            function e(n) {
                for (var e = 0, r = t.length; e < d; ++e)
                    for (var i, o, c, s, l, h, p, v = 0; v < r; ++v) i = t[v], o = i.source, c = i.target, s = c.x + c.vx - o.x - o.vx || nv(), l = c.y + c.vy - o.y - o.vy || nv(), h = Math.sqrt(s * s + l * l), h = (h - a[v]) / h * n * u[v], s *= h, l *= h, c.vx -= s * (p = f[v]), c.vy -= l * p, o.vx += s * (p = 1 - p), o.vy += l * p
            }
            ...
            function n(t) {
                function n(t) {
                    ...
                    if ("c" === p) m = _(t) + m, t = "";
                        ...
                        if (g = (x ? "(" === a ? a : "-" : "-" === a || "(" === a ? "" : a) + g, m = m + ("s" === p ? Lv[8 + _v / 3] : "") + (x && "(" === a ? ")" : ""), y)
    ...
    var Yv, Bv, jv, Hv, Xv, Vv, Wv, $v, Zv, Gv, Jv, Qv, Kv, t_, n_, e_, r_, i_, o_, u_, a_, c_, s_, f_, l_, h_, p_, d_, v_, __, y_, g_ = new pr,
        m_ = 1e-6,
        x_ = 1e-12,
        b_ = Math.PI,
        w_ = b_ / 2,
        ...
        $_ = function(t) {
            ...
            return t_ = n_ = null, Vv === 1 / 0 || Wv === 1 / 0 ? [
                [NaN, NaN],
                [NaN, NaN]
            ] : [
                [Vv, Wv],
    ...
    var Qy = function(t, n) {
        ...
        tg = function(t, n) {
            ...
            for (var a = 0, c = t.length; a < c; ++a)
                if (f = (s = t[a]).length)
                    for (var s, f, l = s[f - 1], h = l[0], p = l[1] / 2 + M_, d = L_(p), v = C_(p), _ = 0; _ < f; ++_, h = g, d = x, v = b, l = y) {
                        var y = s[_],
                            g = y[0],
                            m = y[1] / 2 + M_,
                            x = L_(m),
            ...
            function i(t) {
                ...
                return {
                    ...
                    point: function(l, h) {
                        ...
                        if (!n && (a = i = v) && t.lineStart(), v !== i && (p = o(n, d), (dy(n, p) || dy(d, p)) && (d[0] += m_, d[1] += m_, v = r(d[0], d[1]))), v !== i) f = 0, v ? (t.lineStart(), p = o(d, n), t.point(p[0], p[1])) : (p = o(n, d), t.point(p[0], p[1]), t.lineEnd()), n = p;
                        else if (s && n && c ^ v) {
                            var y;
        ...
        lg = function() {
            ...
            return t.invert = function(t) {
                ...
                return i = c.translate(t).clipExtent([
                    ...
                    [r - .425 * e + m_, a + .12 * e + m_],
                    [r - .214 * e - m_, a + .234 * e - m_]
                ]).stream(l), u = f.translate([r - .205 * e, a + .212 * e]).clipExtent([
                    [r - .214 * e + m_, a + .166 * e + m_],
                    [r - .115 * e - m_, a + .234 * e - m_]
                ]).stream(l), n()
        ...
        bg = function() {
            ...
            return u = {
                ...
                clipExtent: function(i) {
                    return arguments.length ? (d = null == i ? (p = n = e = r = null, ky) : ci(p = +i[0][0], n = +i[0][1], e = +i[1][0], r = +i[1][1]), t()) : null == p ? null : [
                        [p, n],
                        [e, r]
                    ]
                },
    ...
    var Xx = "%Y-%m-%dT%H:%M:%S.%LZ",
        ...
        cb = Oh(Xt(300, .5, 0), Xt(-240, .5, 1)),
        sb = Oh(Xt(-100, .75, .35), Xt(80, 1.5, .8)),
        fb = Oh(Xt(260, .75, .35), Xt(80, 1.5, .8)),
        lb = Xt(),
        hb = function(t) {
        ...
        wb = function() {
            function t() {
                ...
                if (c || (c = t = Re()), l < f && (s = l, l = f, f = s), l > gb)
                    if (d > bb - gb) c.moveTo(l * Math.cos(h), l * Math.sin(h)), c.arc(0, 0, l, h, p, !v), f > gb && (c.moveTo(f * Math.cos(p), f * Math.sin(p)), c.arc(0, 0, f, p, h, v));
                    else {
                        var _, y, g = h,
                            m = p,
                            x = h,
        ...
        lineEnd: function() {
            ...
            if (e)
                if (this._line ? this._context.lineTo(t[0], n[0]) : this._context.moveTo(t[0], n[0]), 2 === e) this._context.lineTo(t[1], n[1]);
                    ...
                    for (var r = Lc(t), i = Lc(n), o = 0, u = 1; u < e; ++o, ++u) this._context.bezierCurveTo(r[0][o], i[0][o], r[1][o], i[1][o], t[u], n[u]);
        ...
        triangles: function() {
            ...
            return this.cells.forEach(function(e, r) {
                if (o = (i = e.halfedges).length)
                    for (var i, o, u, a = e.site, c = -1, s = n[i[o - 1]], f = s.left === a ? s.right : s.left; ++c < o;) u = f, s = n[i[c]], f = s.left === a ? s.right : s.left, u && f && r < u.index && r < f.index && _s(a, u, f) < 0 && t.push([a.data, u.data, f.data])
            }), t
        },
        links: function() {
        ...
        Dw = function() {
            ...
            function f() {
                ...
                if (!y && g.apply(this, arguments)) {
                    var o = a(this, arguments),
                        u = vl(t.event.view).on("mousemove.zoom", n, !0).on("mouseup.zoom", e, !0),
                        c = Rf(this);
            ...
            return n.transform = function(t, n) {
                ...
                return arguments.length ? (m = "function" == typeof t ? t : qw([
                    [+t[0][0], +t[0][1]],
                    [+t[1][0], +t[1][1]]
                ]), n) : m
